                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-6">
                            <a href="index.html" class="app-brand-link">
                                <img src="{{ asset('admin/assets/img/logo/pst-logo.png') }}" width="50"
                                    height="50" alt="">
                    ...
                    <svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path
                        ...
                        fill="#7367F0" />
                                ...
                                {{-- <span class="app-brand-text demo text-heading fw-bold">Company Profile</span> --}}
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-6" action="{{ route('register.authentication') }}"
                            method="POST">
                            @csrf
                            <div class="mb-6">
                            ...
                            <div class="mb-6 form-password-toggle">
                                <label class="form-label" for="password_confirmation">Password Confirmed</label>
                                <div class="input-group input-group-merge">
